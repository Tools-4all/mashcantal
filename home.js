...
כלומר, ההלוואה שלקחנו לפני כמה שנים לא בהכרח תואמת למצבנו כיום ועל כן להתאימה למצב החדש,
וגם באמצעות מחזור ההלוואה אנחנו יכולים להשיג תנאי הלוואה טובים יותר ובכך לחסוך עד מאות אלפי שקלים
מתנאי ההלוואה הקיימת.
...
שיציע לנו את התנאים הטובים ביותר.`
    ...
    p3: {
        ...
        body: `משכנתא עבור זוכי תוכניות "מחיר למשתכן" או "דירה בהנחה" של משרד השיכון והבינוי
שניתנות לרוב בתנאים טובים יותר מאשר בשוק הרגיל ואף אחוז מימון גבוה מ־75%
שמצריך "הון עצמי" נמוך יותר.
...
בשקלול המשתנים הנוכחיים והעתידיים.`
    ...
    p4: {
        ...
        body: `משכנתא לבעלי דירה יחידה אשר מעוניינים לשפר את מגוריהם על ידי רכישת דירה אחרת
תוך התחייבות למכור את הדירה הנוכחית עד 24 חודשים מרגע רכישת הדירה החדשה.

בסוג הלוואה זו ניתן לקבל עד 70% מסכום העסקה בניכוי משכנתא קיימת (באם ישנה).

כלומר אם נשארה לנו יתרת משכנתא בסכום של 100K,
נוכל לקבל הלוואה בגובה של 70% מהעסקה,
למשל דירה במחיר 2M.

גובה הלוואה מקסימלי יהיה:
70% × 2M = 1.4M  
1.4M − 100K = 1.3M.`
    },
    p5: {
