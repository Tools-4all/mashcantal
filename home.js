...
וגם <strong>באמצעות מחזור ההלוואה אנחנו יכולים להשיג תנאי הלוואה טובים יותר ובכך לחסוך עד מאות אלפי שקלים
מתנאי ההלוואה הקיימת.</strong>
...
כלומר אם נשארה לנו יתרת משכנתא בסכום של 100K, נוכל לקבל הלוואה בגובה של 70% מהעסקה למשל דירה  במחיר  2M גובה הלוואה מקסימלי יהיה:
2M*70% = 1.4M-100K = 1.3M`
    },
    p5: {
        title: "משכנתא עבור דירה שנייה ומעלה",
        body: `משכנתא לבעלי דירה אחת לפחות אשר ברצונם לרכוש דירה נוספת. בהלוואה זו יוכלו הלווים לקבל עד 50% מסכום העסקה בניכוי משכנתא קיימת (באם ישנה)כלומר אם נשארה לנו יתרת משכנתא בסכום של 100K, נוכל לקבל הלוואה בגובה של 50% מהעסקה למשל דירה  במחיר  2M גובה הלוואה מקסימלי יהיה:
2M*50% = 1M-100K = 900K
.`
    },
    p6: {
