...
const productsData = {
    ...
    p2: {
        ...
        body: `מחזור הלוואת משכנתא היא בעצם התאמת תנאי ההלוואה למצבנו כיום והוזלת מחיר ההלוואה (הריבית). כלומר, ההלוואה שלקחנו לפני כמה שנים לא בהכרח תואמת למצבנו כיום. 
באמצעות מחזור ההלואה אנחנו יכולים להשיג תנאי הלוואה טובים יותר ובכך לחסוך עד מאות אלפי שקלים מתנאי ההלוואה הקיימת.
...
את המחזור ניתן לבצע בבנק שבו נלקחה הלוואה או בכל בנק שיציע לנו את התנאים הטובים ביותר.`
    ...
    p3: {
        ...
        body: `משכנתא עבור זוכי תוכניות "מחיר למשכתן" או "דירה בהנחה" של משרד השיכון והבינוי".

במשכנתא שכזו, חשוב להתחשב בעובדה שהכניסה לדירה היא עתידית אך תשלום המשכנתא מתחיל מיידית בנוסף להוצאות השוטפות נוכחיות כמו שכ"ד וכו' ולפיכך יש להתאים את מסלולי ההלוואה הנכונים בשקלול המשתנים הנוכחיים והעתידיים.`
    },
    p4: {
...
כלומר אם נשארה לנו יתרת משכנתא בסכום של 100K, נוכל לקבל הלוואה בגובה של 70% מהעסקה פחות 100K.`
    },
    p5: {
        title: "משכנתא עבור דירה שנייה ומעלה",
        body: "משכנתא לבעלי דירה אחת לפחות אשר ברצונם לרכוש דירה נוספת. בהלוואה זו יוכלו הלווים לקבל עד 50% מסכום העסקה בניכוי משכנתא קיימת (באם ישנה) כפי שפורט במשכנתא לשיפור דיור."
    },
    p6: {
...
בהלוואה שכזו ניתן לקבל עד 50% משווי הנכס ועוד 200 אלף ש"ח.`
    },
    p7: {
        title: "משכנתא הפוכה לבני 55 +",
        body: `משכנתא לבעלי דירות מעל גיל 55 אשר ברצונם לקחת הלוואה 
על חשבון הנכס,
כלומר משכון הנכס לבנק ללא צורך בהון עצמי.

בהלוואה מסוג זה
ככל שגיל הלווים גבוה יותר כך עולים אחוזי ההלוואה מתוך שווי הבית. 
כלומר שככל שהלווה מבוגר יותר כך הוא יכול לקבל הלוואה גבוהה יותר מתוך שווי הבית.

להבדיל ממשכנתא למינוף נכס קיים, במשכנתא זו אפשר לפרוע את ההלוואה על ידי יורשי הנכס לאחר מות אחרון הלווים 
כשבכל מקרה סכום הפרעון לא יעלה על שווי הבית.`
    }
};
