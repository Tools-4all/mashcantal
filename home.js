...
const productsData = {
    ...
    p7: {
        ...
        body: "משכנתא לבעלי דירות מעל גיל 55 המעוניינים לקבל כסף כנגד שיעבוד הנכס. ככל שגיל הלווים גבוה יותר, כך אחוז ההלוואה משווי הדירה עולה. משכנתא זו שונה ממשכנתא \"לכל מטרה\" באופן הפירעון: החזר ההלוואה מתבצע על ידי הלווים לאורך חייהם או על ידי היורשים, לאחר פטירתם."
    },
};
